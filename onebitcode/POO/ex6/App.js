...
module.exports = class App{
    ...
    static transfer(fromUserEmail, toUserEmail, value){
        ...
        if(fromUser && toUser){
            const newTrasfer = new Trasfer(fromUser,toUser,value)
            fromUser.account.addTransfer(newTrasfer)
            toUser.account.addTransfer(newTrasfer)
        }
    }
